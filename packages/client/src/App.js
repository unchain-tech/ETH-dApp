...
const App = () => {
  ...
  const contractAddress = "0x05197d7c95c3f5b7619cFACB5061e7d998F3c71E";
  ...
  const wave = async () => {
    try {
      ...
      if (ethereum) {
        ...
        console.log("Retrieved total wave count...", count.toNumber());
        // let contractBalance = await provider.getBalance(wavePortalContract.address); エラー回避のためコメントアウト
